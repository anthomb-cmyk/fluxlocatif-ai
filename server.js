...
async function sendAppInstallEmail({ email, name }) {
  ...
  const html = renderEmailLayout({
    ...
    paragraphes: [
      salutation,
      "Votre portail FluxLocatif peut vivre sur l’écran d’accueil de votre iPhone, comme n’importe quelle application. C’est la meilleure façon de l’utiliser au quotidien.",
      "Installé ainsi, il s’ouvre <strong>en plein écran</strong>, sans barre d’adresse ni onglets: vous gagnez de la hauteur pour vos dossiers et vos logements. Vous y accédez <strong>d’un seul geste</strong>, sans le chercher parmi vos onglets ni retaper l’adresse. L’expérience est franchement plus agréable que par le navigateur.",
  ...
  const text = [
    ...
    "comme n'importe quelle application. C'est la meilleure facon de l'utiliser",
    "au quotidien: il s'ouvre en plein ecran, sans barre d'adresse ni onglets,",
    "et vous y accedez d'un seul geste.",
    "",
